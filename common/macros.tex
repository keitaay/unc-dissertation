...
% \newtheorem{hyp}{Hypothesis}[chapter] %uncomment to set hypothesis counter to restart at each chapter
% \renewcommand{\thehyp}{\arabic{hyp}} % uncomment to remove chapter number from prefix of hypothesis numbering
