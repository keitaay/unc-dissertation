...
\chapter{A Chapter with Examples of Special Elements}
...
Rather than quotes, equations, or theorems, it may also be useful to express text in the form of code or pseudocode. Algorithm~\ref{alg:cap} is an example of a code block, which is formatted using the \texttt{algpseudocode} environment. The content of the code block is just some placeholder text, and it is meant to demonstrate how a code block would look in the final document.
