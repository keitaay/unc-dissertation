...
\input{parts/transplant/source/table-demographics.tex}
...
\input{parts/transplant/source/table-biopsies.tex}

% Table of Banff biopsy scores
\input{parts/transplant/source/table-scores.tex}
...
\input{parts/transplant/source/fig-doa-all.tex}

% Box plot of PD, RE, RV-based RR strat by i, IFTA, i-IFTA scores, rejection
\input{parts/transplant/source/fig-rr-all.tex}

% Table of regressor performance metrics for clinical variables
\input{parts/transplant/source/table-regression.tex}

% Table of classifier performance metrics for clinical variables
\input{parts/transplant/source/table-classification.tex}
